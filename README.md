...
```
to the `langlist` element of `site config/site.js`. Then please add directories named `th-th` in `docs`and `blog` directories , here you can add documents in this language . 
