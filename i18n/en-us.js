  ...
  hackathon: {
    ...
    activity: {
      ...
      activityList: [{
        ...
        class_name: 'a1',
        name: 'time',
        content: 'March 6 to March 8, 2020'
      },{
        image_name: 'activity2.png',
        class_name: 'a2',
        name: 'method',
        content: 'A completely online approach that encourages distributed collaboration'
      },{
        image_name: 'activity3.png',
        class_name: 'a3',
        name: 'content',
        content: 'Design and development competition according to the data provided by "wuhan 2020", complete work submission and introduction video (creativity, work introduction and significance).'
      },{
        image_name: 'activity4.png',
        class_name: 'a4',
        name: 'reward',
        content: 'Judges and the community rank participants and projects and award winners.'
      },
    ]
    },
    holder: {
