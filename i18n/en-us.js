export default {
  ...
  hackathon: {
    ...
    participant: {
      name: 'participant',
      person: 'competitor',
      person_description_1: 'Developers from open source communities, such as Wuhan2020 and other communities on GitHub, have great ideas and prototypes that solve current challenges and create Shared value;',
      person_description_2: 'Volunteers who want to improve their social impact through open source;',
      person_description_3: 'Entrepreneurs who actively respond to the covid-19 challenge and social emergency crisis.',
      audience: 'audience',
      audience_description_1: 'Individuals and teams participate in Hackathon',
