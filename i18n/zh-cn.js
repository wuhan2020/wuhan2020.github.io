        ...
        list: [
{
          ...
          link: '/zh-cn/blog/summer-2020.html',
            ...
            {
          img: '/images/blog/picture/6404.jpeg',
          title: '五四青年节',
          content: '五四青年节',
          dateStr: '2020年05月04日',
          link: '/zh-cn/blog/youth-day.html',
            ...
            {
          img: '/images/blog/picture/640.png',
          ...
          {
          img: '/images/blog/white-paper/640',
        ...
        {
          img: '/images/blog/media/nav-project-introduced.webp',
  ...
  hackathonKanban: {
    ...
    teamData: {
      ...
      list: [
        ...
        {"id":"3","subject":"特效药和疫苗研发团队沟通社区","leader":"权泉","members":["权泉"],"tutor":"-","abstract":"通过连接各国特效药和疫苗研发团队，促进沟通和经验分享，提高研发效率"},
        {"id":"4","subject":"高校健康打卡平台","leader":"张齐勋（沧海猎人）","members":["张齐勋","张雨 ","康楠楠 ","苗苏琪","张智源","康赫敏  ","刘刚健 ","李理  ","金鑫 ","赵前 ","符豫 ","何洪波 ","杨成昊 ","杨瑛 ","陈希 ","盛禹 ","张静 ","王亚星","李圆圆","杜嘉卓","肖俊伦"],"tutor":"-","abstract":"针对高校设计一套开源的可本地部署的疫情健康打卡管理平台"},
        {"id":"5","subject":"安全出行地图小程序","leader":"liuchangfreeman","members":[],"tutor":"-","abstract":"在地图上显示新冠肺炎感染情况"},
        {"id":"6","subject":"DiagnoseMe","leader":"TRAORE Sy Adama","members":["TRAORE Sy Adama","BAGBILA Flavie Boris","KONKOBO Maxime Pakindessama","NIKIEMA Faissal"],"tutor":"-","abstract":"Diagnosis, alert and geolocation plateform for detection of suspect cases in real time"},
        {"id":"7","subject":"病毒传播预测模型","leader":"herozabai","members":[],"tutor":"-","abstract":"模型预测每一个选择会对病毒传播趋势产生的影响"},
        {"id":"8","subject":"Geographic Map of Genomic Epidemiology","leader":"肚肚","members":[],"tutor":"－","abstract":"A Geographic map can help us understand the virus spreading history"},
        {"id":"9","subject":"数字建模分析ncov海外疫情对中国的影响","leader":"liumce1","members":[],"tutor":"-","abstract":"运用有效的数据采集建立数学模型，分析国外疫情对中国的影响，，有无疫情反转的可能，及日韩等国家对中国经济的影响"},
        {"id":"10","subject":"智能健康出行","leader":"陈莉","members":["陈莉","唐子轶 ","马铭","洪诗阳"],"tutor":"-","abstract":"实时展示景区（公共场所）的人员汇集情况，以及智能规划出游路线"},
        {"id":"11","subject":"蓝莓宅急便","leader":"Siyu Chen ","members":["Helen Chang","Shulu Fu"],"tutor":"-","abstract":"解决疫情期间由于出行限制，物流，销售渠道受限，以及信息不对称造成的鲜蔬果，海鲜以及shelf life较短的物品供给问题 - 消费者更难买到，供给商/农民更难卖出，同时提高居家生活质量，帮助鼓励市民减少出行，从而进一步帮助控制疫情"},
        {"id":"12","subject":"中医AI诊断系统","leader":"黄健平","members":["黄健平","杨凡","黄华君"],"tutor":"-","abstract":"患者自己在家通过症状描述，AI系统给出专业的中医建议。"},
        {"id":"13","subject":"MapCure","leader":"韩京儒","members":["韩京儒","罗帆","李国宝","刘果夫","郭正航","王懿","吴嘉皓","陈祖沛","杨航博","饶淙元","张兴","傅成超"],"tutor":"-","abstract":"前线地图交互，中路助力打榜，后方信息汇总。"},
        {"id":"14","subject":"Nedelp设计联名众筹","leader":"何忠豪 ","members":["陈思晓","何忠豪"],"tutor":"-","abstract":"联名品牌做疫情特别版，收入的一部分短期用于抗疫，长期用来系统地为世界完善公共卫生系统以防类似瘟疫降临作准备。"},
        {"id":"15","subject":"一站式疫情数据开放平台","leader":"谢文睿","members":["谢文睿","胡稳 ","谷勇杰 ","陈焕森","于鸿飞","伊雪 ","刘广月 ","李青 ","张峰 ","江水","居居"],"abstract":"一个用来收集疫情数据的标注平台"},
        {"id":"16","subject":"疫城记","leader":"孔令远","members":["孔令远","黄智仁","地才"],"abstract":"通过高维疫情数据可视化去呈现各城市的疫情发展，通过对比不同城市的情况为决策提供依据"},
        {"id":"17","subject":"『H』(hope&happiness)","leader":"姚欣兰","members":["姚欣兰","折光润","林芷若","Kaiqi Zhu 朱恺琦","谢翠红","施泽强","张国杰","谢如歌"],"tutor":"-","abstract":"提供小故事、小练习等形式的精神食粮，帮助焦虑人群，重新认识我们与世界、我们与自然、我们与自己的关系。"},
        {"id":"18","subject":"医书","leader":"change","members":[],"tutor":"-","abstract":"一个快速发现疫情的知识型平台"},
        {"id":"19","subject":"身心医学提升免疫力社区","leader":"谢翠红","members":[],"tutor":"-","abstract":"为隔离在家人员营造譬如冥想、太极这样有利于提升免疫力以及改善情绪的线上打卡和教学的环境"},
        {"id":"20","subject":"Epidemic prediction and notification triggering system","leader":"Leona Lee","members":["Leona Lee","Muhammad Ashfaq","Muhammad Shahzad","Abu Sad Muhammed Arif Ali","Abdul Ghaffar"],"tutor":"-","abstract":"\"A prediction system that will form a model to show the worst scenario when the first infected case is confirmed; therefore, sending notifications to major factories so they can prepare enough e.g. masks and disinfectant."},
        {"id":"21","subject":"“疫”记","leader":"刘铭","members":["刘铭","孔逸鹏","钟强"],"tutor":"-","abstract":"用户通过日记方式记录“战疫”的故事，小程序以时间线的形式来展现疫情期间人们的故事，以及不同时间段人们日记中探讨最多的关键字！"},
        {"id":"22","subject":"疫情智能机器人-小源 ","leader":"宋永乐","members":["宋永乐","陈阳","蒋诗哲","程刚","李思颖","田迎港","张黄登","王培琰","惠世冀"],"tutor":"-","abstract":"搭建小源疫情机器人，为用户提供有关疫情信息的查询"},
        {"id":"23","subject":"你的名字(白疫陵园)","leader":"宝塔","members":["宝塔","JuliaLau","eva_chenaw","endeavor","王子涵"],"tutor":"-","abstract":"纪念疫情逝去的英雄人物，在线祭奠"},
        {"id":"24","subject":"SmartKG","leader":"李烨","members":[""],"tutor":"-","abstract":"国际物资捐赠信息溯源"},
        {"id":"25","subject":"翔鹰验收","leader":"Anna Xiang","members":["Anna Xiang","Panagiotis Samiotis","丁磊"],"abstract":"国际物资捐赠信息溯源"},
        {"id":"26","subject":"疫情故事商店","leader":"谢克生","members":["严骏","谢克生","金彤彤","莫观德","杜泽乔","谢如歌"],"tutor":"-","abstract":"一个分享普通用户在疫情期间的故事，在故事商店中出售，收益转化为公益基金"},
        {"id":"27","subject":"从2020年起新生","leader":"许弼程","members":[],"tutor":"-","abstract":"如果没有明天，请从此刻起开始热爱地球、热爱生命"},
        {"id":"28","subject":"volunteer certificate","leader":"赵丰","members":[],"tutor":"-","abstract":"generalize the volunteer digital certificate from a template picture and a list of names"},
        {"id":"29","subject":"智能防护面罩","leader":"eva_chenaw","members":["eva_chenaw","JuliaLau"],"tutor":"-","abstract":"解决物理隔离+出行安全系数监测+其他健康贴心服务"},
        {"id":"30","subject":"City Hero","leader":"赵靓","members":["赵靓","邓文浩","黎杨","阴慧辉","唐雨欣","彭一清","石生辉","熊梓丘"],"abstract":"以一个平凡人的视角重现一段不平凡的历史"},
        {"id":"31","subject":"寻找接触者","leader":"lfg","members":[],"tutor":"-","abstract":"提供寻找接触过病毒者，或者寻找疑似病毒者的信息展示平台"},
        {"id":"32","subject":"求助地图","leader":"LEE","members":[],"tutor":"-","abstract":"基于地图地理位置进行求助与援助动作的平台"},
        {"id":"33","subject":"疫情命运共同体","leader":"韩布丹","members":["韩布丹","吕心然","时雨萌","孙樱倩","关茗月","翁振杰","司玉鑫","李永程","邱江瑞"],"tutor":"-","abstract":"给予部分缺乏防护意识的群众以有针对的提醒"},
        {"id":"34","subject":"基于区块链的中医药溯源系统","leader":"麻锦涛","members":["麻锦涛","阮海航","赵宇"],"abstract":"将区块链技术与供应链溯源系统相结合，利用区块链技术的优势解决疫情结束后中医药供应链溯源系统中存在的诸多问题"},
        {"id":"35","subject":"Safe Zone","leader":"13585769800","members":[],"tutor":"-","abstract":"基于公开的疑似，确诊病例发现地，根据当前地理位置推送警告通知"},
        {"id":"36","subject":"COEXvsVIRUS","leader":"ili","members":[],"tutor":"-","abstract":"\"Building a convertible multi-purpose ecosystem of drones, thus giving a wholesome answer to challenges caused by epidemics and other emergencies--- performing: "},
        {"id":"37","subject":"autovax","leader":"William Heath","members":["William Heath","He Huang","Joann Arce","Wendy Liu","Junior McGrath","Binod Bajracharya","Jang Leong Chia"],"tutor":"-","abstract":"-"},
