export default {
  ...
  hackathonKanban: {
    ...
    teamData: {
      ...
      list: [
        {"id":"1","name":"认识病毒","leader":"张婉昱","members":["张婉昱","苏建勋 ","陈诺","刘付刚","齐泽文 ","郝东霞","王仁宇","折光润","何钰婷","黄诗涵","Asimova Qiu"],"tutor":"-","abstract":"关于病毒的一个趣味性教育App"},
        {"id":"2","name":"Aid Tracker捐赠直连——捐赠对接与追踪一体化平台","leader":"Bingyang Wang 汪冰洋","members":["Bingyang Wang 汪冰洋","赵鹏","毛昌启","阮健","Shihang Su苏世航 ","万涛","曹书韵 ","许辛鹏 ","Linsons","陈崇强 ","张艾如","何晓姗","姜立洋","刘香杉"],"abstract":"捐赠对接与追踪一体化平台"},
        {"id":"3","name":"特效药和疫苗研发团队沟通社区","leader":"权泉","members":["权泉"],"tutor":"-","abstract":"通过连接各国特效药和疫苗研发团队，促进沟通和经验分享，提高研发效率"},
        {"id":"4","name":"高校健康打卡平台","leader":"张齐勋（沧海猎人）","members":["张齐勋","张雨 ","康楠楠 ","苗苏琪","张智源","康赫敏  ","刘刚健 ","李理  ","金鑫 ","赵前 ","符豫 ","何洪波 ","杨成昊 ","杨瑛 ","陈希 ","盛禹 ","张静 ","王亚星","李圆圆","杜嘉卓","肖俊伦"],"tutor":"-","abstract":"针对高校设计一套开源的可本地部署的疫情健康打卡管理平台"},
        {"id":"5","name":"安全出行地图小程序","leader":"liuchangfreeman","members":[],"tutor":"-","abstract":"在地图上显示新冠肺炎感染情况"},
        {"id":"6","name":"DiagnoseMe","leader":"TRAORE Sy Adama","members":["TRAORE Sy Adama","BAGBILA Flavie Boris","KONKOBO Maxime Pakindessama","NIKIEMA Faissal"],"tutor":"-","abstract":"Diagnosis, alert and geolocation plateform for detection of suspect cases in real time"},
        ...
        {"id":"10","name":"智能健康出行","leader":"陈莉","members":["陈莉","唐子轶 ","马铭","洪诗阳"],"tutor":"-","abstract":"实时展示景区（公共场所）的人员汇集情况，以及智能规划出游路线"},
        {"id":"11","name":"蓝莓宅急便","leader":"Siyu Chen ","members":["Helen Chang","Shulu Fu"],"tutor":"-","abstract":"解决疫情期间由于出行限制，物流，销售渠道受限，以及信息不对称造成的鲜蔬果，海鲜以及shelf life较短的物品供给问题 - 消费者更难买到，供给商/农民更难卖出，同时提高居家生活质量，帮助鼓励市民减少出行，从而进一步帮助控制疫情"},
        {"id":"12","name":"中医AI诊断系统","leader":"黄健平","members":["黄健平","杨凡","黄华君"],"tutor":"-","abstract":"患者自己在家通过症状描述，AI系统给出专业的中医建议。"},
        {"id":"13","name":"MapCure","leader":"韩京儒","members":["韩京儒","罗帆","李国宝","刘果夫","郭正航","王懿","吴嘉皓","陈祖沛","杨航博","饶淙元","张兴","傅成超"],"tutor":"-","abstract":"前线地图交互，中路助力打榜，后方信息汇总。"},
        ...
        {"id":"21","name":"“疫”记","leader":"刘铭","members":["刘铭","孔逸鹏","钟强"],"tutor":"-","abstract":"用户通过日记方式记录“战疫”的故事，小程序以时间线的形式来展现疫情期间人们的故事，以及不同时间段人们日记中探讨最多的关键字！"},
        {"id":"22","name":"疫情智能机器人-小源 ","leader":"宋永乐","members":["宋永乐","陈阳","蒋诗哲","程刚","李思颖","田迎港","张黄登","王培琰","惠世冀"],"tutor":"-","abstract":"搭建小源疫情机器人，为用户提供有关疫情信息的查询"},
        {"id":"23","name":"你的名字(白疫陵园)","leader":"宝塔","members":["宝塔","JuliaLau","eva_chenaw","endeavor","王子涵"],"tutor":"-","abstract":"纪念疫情逝去的英雄人物，在线祭奠"},
        {"id":"24","name":"SmartKG","leader":"李烨","members":[""],"tutor":"-","abstract":"国际物资捐赠信息溯源"},
        {"id":"25","name":"翔鹰验收","leader":"Anna Xiang","members":["Anna Xiang","Panagiotis Samiotis","丁磊"],"abstract":"国际物资捐赠信息溯源"},
        {"id":"26","name":"疫情故事商店","leader":"谢克生","members":["严骏","谢克生","金彤彤","莫观德","杜泽乔","谢如歌"],"tutor":"-","abstract":"一个分享普通用户在疫情期间的故事，在故事商店中出售，收益转化为公益基金"},
        {"id":"27","name":"从2020年起新生","leader":"许弼程","members":[],"tutor":"-","abstract":"如果没有明天，请从此刻起开始热爱地球、热爱生命"},
        {"id":"28","name":"volunteer certificate","leader":"赵丰","members":[],"tutor":"-","abstract":"generalize the volunteer digital certificate from a template picture and a list of names"},
        {"id":"29","name":"智能防护面罩","leader":"eva_chenaw","members":["eva_chenaw","JuliaLau"],"tutor":"-","abstract":"解决物理隔离+出行安全系数监测+其他健康贴心服务"},
        {"id":"30","name":"City Hero","leader":"赵靓","members":["赵靓","邓文浩","黎杨","阴慧辉","唐雨欣","彭一清","石生辉","熊梓丘"],"abstract":"以一个平凡人的视角重现一段不平凡的历史"},
        ...
        {"id":"33","name":"疫情命运共同体","leader":"韩布丹","members":["韩布丹","吕心然","时雨萌","孙樱倩","关茗月","翁振杰","司玉鑫","李永程","邱江瑞"],"tutor":"-","abstract":"给予部分缺乏防护意识的群众以有针对的提醒"},
        {"id":"34","name":"基于区块链的中医药溯源系统","leader":"麻锦涛","members":["麻锦涛","阮海航","赵宇"],"abstract":"将区块链技术与供应链溯源系统相结合，利用区块链技术的优势解决疫情结束后中医药供应链溯源系统中存在的诸多问题"},
        ...
        {"id":"37","name":"autovax","leader":"William Heath","members":["William Heath","He Huang","Joann Arce","Wendy Liu","Junior McGrath","Binod Bajracharya","Jang Leong Chia"],"tutor":"-","abstract":"-"},
