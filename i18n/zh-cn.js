...
home: {
  brand: {
    brandName: 'Wuhan2020 社区是做什么的?',
      briefIntroduction
  :
    '我们当前在做的事是：建立一个医院、工厂、采购等信息实时同步的数据服务，同时召集所有希望对这次抗击病毒战役进行贡献的人，让每个具有相关技能的人都可以参与相关主题的开发工作，用开源的社区文化，以自组织协作的方式完成。',
      buttons
  :
    [
      {
...
,
  ...
  :
    '表现方式（不限于）',
      form
  :
    ['视频、动画等艺术设计作品', '动态网页', '开源数据', '数据的分析预测模型',
