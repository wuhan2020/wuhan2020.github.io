export default {
  ...
  'it-it': {
    brand: {
      brandName: 'Di cosa si occupa la community Wuhan2020?',
  ...
  'ja-jp': {
    brand: {
      ...
      briefIntroduction: '現在私たちがしていることは、病院、工場、調達、その他の情報のためのリアルタイムの同期データサービスを確立し、関連するスキルを持つすべての人が 関連トピックの開発に参加し、オープンソースのコミュニティ文化と自己組織化された共同の方法でそれを完了します。',
      buttons: [
        {
          text: '始めましょう',
