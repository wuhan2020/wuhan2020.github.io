      ...
      <div className="hackathon-page">
        ...
        <section className="hackathon-section">
          ...
          <div id="register">
            ...
            <a href={getLink(`/${language}/hackathonKanban/index.html`)}>
              <button style={{cursor: "pointer"}}> {dataSource.application.application} </button>
            </a>
          ...
          <div id="holder">
            ...
            <div><a href="https://www.freecodecamp.org/"><img
              src="/images/hackathon/holder_coorperation/holder_coorperation1.png"/></a></div>
            <div><a href="http://ceoceo.org/"><img
              src="/images/hackathon/holder_coorperation/holder_coorperation2.png"/></a></div>
            <div><a href="https://www.linkstars.com/"><img
              src="/images/hackathon/holder_coorperation/holder_coorperation3.png"/></a></div>
            <div><a href="https://www.agora.io/"><img
              src="/images/hackathon/holder_coorperation/holder_coorperation4.png"/></a></div>
          </div>
          <div id="holder">
          ...
          <div id="holder">
            ...
            <div></div>
            <div></div>
            <div><a href="https://www.runtheworld.today/"><img
              src="/images/hackathon/platform_support/platform_support1.png"/></a></div>
          </div>
